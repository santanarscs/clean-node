...
import { UserRepository } from '../../../src/usecases/register-use-on-mailing-list/ports/user-repository'
import { RegisterUserOnMailingList } from '../../../src/usecases/register-use-on-mailing-list/register-user-on-mailing-list'
